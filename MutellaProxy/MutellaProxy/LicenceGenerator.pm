...
sub GenerateLicence(){
	...
	my $TempCheckSum	= MutellaProxy::CryptoLibrary->GenerateTemporaryKey();
	my $SimpleURandom	= MutellaProxy::CryptoLibrary->SimpleURandom( 10000 );
	my $URandom			= MutellaProxy::CryptoLibrary->URandom( 10000 );
	my $SimpleRandom	= MutellaProxy::CryptoLibrary->SimpleRandom();
	my $TimeStamp		= MutellaProxy::Time->GetCurrentTimeStamp();
	my $CurrentTime		= MutellaProxy::Time->MySQLDateTime();
	
	my $TempCheckSumMD5	= MutellaProxy::CheckSum->MD5ToHEX( \$TempCheckSum ); 
	my $SimpleRandomMD5	= MutellaProxy::CheckSum->MD5ToHEX( \$SimpleRandom ); 
	my $URandomMD5		= MutellaProxy::CheckSum->MD5ToHEX( \$URandom ); 
	my $CurrentTimeMD5	= MutellaProxy::CheckSum->MD5ToHEX( \$CurrentTime ); 
	my $TimeStampMD5	= MutellaProxy::CheckSum->MD5ToHEX( \$TimeStamp ); 
	my $SimpleURandomMD5= MutellaProxy::CheckSum->MD5ToHEX( \$SimpleURandom ); 
	
	my $TempCheckSumMD4	= MutellaProxy::CheckSum->MD4ToHEX( \$TempCheckSum ); 
	my $SimpleRandomMD4	= MutellaProxy::CheckSum->MD4ToHEX( \$SimpleRandom ); 
	my $URandomMD4		= MutellaProxy::CheckSum->MD4ToHEX( \$URandom ); 
	my $CurrentTimeMD4	= MutellaProxy::CheckSum->MD4ToHEX( \$CurrentTime ); 
	my $TimeStampMD4	= MutellaProxy::CheckSum->MD4ToHEX( \$TimeStamp ); 
	my $SimpleURandomMD4= MutellaProxy::CheckSum->MD4ToHEX( \$SimpleURandom );

	my $TempCheckSumSHA	= MutellaProxy::CheckSum->SHA1ToHEX( \$TempCheckSum ); 
	my $SimpleRandomSHA	= MutellaProxy::CheckSum->SHA1ToHEX( \$SimpleRandom ); 
	my $URandomSHA		= MutellaProxy::CheckSum->SHA1ToHEX( \$URandom ); 
	my $CurrentTimeSHA	= MutellaProxy::CheckSum->SHA1ToHEX( \$CurrentTime ); 
	my $TimeStampSHA	= MutellaProxy::CheckSum->SHA1ToHEX( \$TimeStamp ); 
	my $SimpleURandomSHA= MutellaProxy::CheckSum->SHA1ToHEX( \$SimpleURandom );
	...
	my $Shuffled1 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArray );
	my $Shuffled2 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArray );
	my $Shuffled3 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArray );
	my $Shuffled4 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArray );
	my $Shuffled5 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArray );
	my $Shuffled6 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArray );

	my $md5_1 = MutellaProxy::CheckSum->MD5ToHEX( \$Shuffled1 );
	my $md4_1 = MutellaProxy::CheckSum->MD4ToHEX( \$Shuffled1 );
	my $sha_1 = MutellaProxy::CheckSum->SHA1ToHEX( \$Shuffled1 );

	my $md5_2 = MutellaProxy::CheckSum->MD5ToHEX( \$Shuffled2 );
	my $md4_2 = MutellaProxy::CheckSum->MD4ToHEX( \$Shuffled2 );
	my $sha_2 = MutellaProxy::CheckSum->SHA1ToHEX( \$Shuffled2 );

	my $md5_3 = MutellaProxy::CheckSum->MD5ToHEX( \$Shuffled3 );
	my $md4_3 = MutellaProxy::CheckSum->MD4ToHEX( \$Shuffled3 );
	my $sha_3 = MutellaProxy::CheckSum->SHA1ToHEX( \$Shuffled3 );

	my $md5_4 = MutellaProxy::CheckSum->MD5ToHEX( \$Shuffled4 );
	my $md4_4 = MutellaProxy::CheckSum->MD4ToHEX( \$Shuffled4 );
	my $sha_4 = MutellaProxy::CheckSum->SHA1ToHEX( \$Shuffled4 );

	my $md5_5 = MutellaProxy::CheckSum->MD5ToHEX( \$Shuffled5 );
	my $md4_5 = MutellaProxy::CheckSum->MD4ToHEX( \$Shuffled5 );
	my $sha_5 = MutellaProxy::CheckSum->SHA1ToHEX( \$Shuffled5 );

	my $md5_6 = MutellaProxy::CheckSum->MD5ToHEX( \$Shuffled6 );
	my $md4_6 = MutellaProxy::CheckSum->MD4ToHEX( \$Shuffled6 );
	my $sha_6 = MutellaProxy::CheckSum->SHA1ToHEX( \$Shuffled6 );
	...
	%CheckSumHash =	(
		...
		"47"	=> $md4_6,
		"48"	=> $sha_6,
		"49"	=> MutellaProxy::CryptoLibrary->URandom( 10000 ),
		"50"	=> MutellaProxy::CryptoLibrary->SimpleRandom(),
		"51"	=> MutellaProxy::CryptoLibrary->SimpleURandom( 99812 ),
	); # my %CheckSumHash =	()
	...
	my $c1 = MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand1} );
	my $c2 = MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand2} );
	my $c3 = MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand3} );
	my $c4 = MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand4} );
	my $c5 = MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand5} );
	my $c6 = MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand6} );
	my $c7 = MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand7} );
	my $c8 = MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand8} );
	my $c9 = MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand9} );
	...
	my $BubbleScalar1 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );
	my $BubbleScalar2 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );
	my $BubbleScalar3 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );

	my $BubbleScalar4 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );
	my $BubbleScalar5 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );
	my $BubbleScalar6 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );

	my $BubbleScalar7 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );
	my $BubbleScalar8 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );
	my $BubbleScalar9 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );

	my $FF1 = MutellaProxy::CheckSum->MD5ToHEX( $c1 . $BubbleScalar2 . $c5 );
	my $FF2 = MutellaProxy::CheckSum->MD4ToHEX( $BubbleScalar5 . $c4 . $c6 );
	my $FF3 = MutellaProxy::CheckSum->SHA1ToHEX( $c7 . $c2 . $BubbleScalar4 );

	my $FF4 = MutellaProxy::CheckSum->MD5ToHEX( $c9 . $BubbleScalar8 . $BubbleScalar7 );
	my $FF5 = MutellaProxy::CheckSum->MD4ToHEX( $BubbleScalar1 . $c8 . $BubbleScalar9 );
	my $FF6 = MutellaProxy::CheckSum->SHA1ToHEX( $BubbleScalar3 . $BubbleScalar6 . $c3 );
	...
	my $CipherText = MutellaProxy::CryptoLibrary->Encrypt( MutellaProxy::CheckSum->MD5ToHEX( $CheckSumHash{$rand111} ) , MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced ) );
	
	my $t1 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArrayAdvanced );
	my $t2 = MutellaProxy::CryptoLibrary->ShuffleArrayAdvanced( \@CheckSumArray );

	# Eigentliche Lizenz generieren
	$Licence = MutellaProxy::CheckSum->MD5ToHEX( $CipherText . $FF1 . $Shuffled3 . $FF2 . $FF3 . $URandom . $SimpleURandom . $FF4 . $FF5 . $FF6 . $t1 . $t2 . %CheckSumHash->{$rand222} . %CheckSumHash->{$rand333} . %CheckSumHash->{$rand444} ); 
...
sub SaveLicenceSQLToFile(){
   ...
   my $CurTime		=  MutellaProxy::Time->SimpleMySQLDateTime();
   my $StorePath	= "$LICENCESTOREPATH/$CurTime-LicenceSQL.txt"; 

	open(STORE,"+>>$StorePath") or sub { warn "MutellaProxy::LicenceGenerator->SaveLicenceSQLToFile(): IO ERROR: $!\n"; return -1; };
	flock (STORE, 2);
...
sub SaveCryptoSQLToFile(){
   ...
   my $StorePath	= "$LICENCESTOREPATH/$CurTime-CryptoSQL.txt"; 
	...
	open(STORE,"+>>$StorePath") or sub { warn "MutellaProxy::LicenceGenerator->SaveCryptoSQLToFile(): IO ERROR: $!\n"; return -1; };
	flock (STORE, 2);
