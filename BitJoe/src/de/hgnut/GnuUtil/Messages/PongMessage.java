/*
Antworet auf ein Ping benötigt den Ping um ordenlicher Pong zu sein
*/
...
public class PongMessage extends Message {
	 ...
	 */
	public PongMessage(short port, String ipAddress, int fileCount, int fileSize) {
		super(Message.PONG);
	 ...
	 */
	public PongMessage(short[] rawMessage, GnuConnection originatingConnection) {
