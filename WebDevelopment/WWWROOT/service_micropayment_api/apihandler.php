...
# http://www.bitjoe.de/service_micropayment_api/apihandler.php?amount=995&title=Bitjoe_Volumen_Tarif_30_Suchanfragen&auth=712da28a3bd0f9e7fca3e7bc0c10afef&country=DE&currency=EUR&free=flat24_ebank_01607979247_1211193243&function=billing
...
if ( strcmp($function, "billing") == 0 ) {
	...
	if ( strcmp($MobileTarif, "volumelow") == 0 ){
		...
		$hc_userType			= 2;
		$web_servicetype		= 1;
		$hc_contingent_volume_success	+= BUY_HANDYTARIF_1_SUCCESS; 
