...
$Username		= generatePassword( 10 );
$Password		= generatePassword( 8 );
$DataValidUntil = GetValidUntilDate( $CurrentDate, $DaysValidNewAccount );
$web_up_MD5		= md5(strtolower($Username.$Password));


$BJParisDBUPdate = "INSERT INTO `bjparis_new` ( `username`,`password`,`account_valid_until`, `searchcontingent`, `created`, `hc_sec1_MD5`,`hc_sec2_MD5`,`hc_sec3_MD5`,`hc_sec4_MD5`,`hc_sec5_MD5`,`web_up_MD5`) VALUES ( '$Username','$Password','$DataValidUntil','$SearchesNewAccount',NOW(),'','','','','','$web_up_MD5' );";
...
fputs($log_handle,"NEWUSER#$NOW#$Username#$Password#$DataValidUntil#$web_up_MD5#$AccountParam#$SearchesNewAccount\n");
fclose($log_handle);
