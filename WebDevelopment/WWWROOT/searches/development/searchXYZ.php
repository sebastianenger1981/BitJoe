...
require_once("/server/wwwroot/searches/http.inc.php");
require_once("/server/wwwroot/searches/fuzzy.inc.php");

$ResultCount	= trim($_REQUEST["results"]);
...
$usenext_filter_file	= "/server/wwwroot/searches/usenext_blocker.txt";
