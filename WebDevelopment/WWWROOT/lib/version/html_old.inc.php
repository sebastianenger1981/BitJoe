...
<table width="778" border="0" cellpadding="0" cellspacing="0" height="762">
  ...
  <tr>
	...
	<p align="left">
	<span style="font-size: 8pt;">Du bist hier:</span> <span style="FONT-SIZE: 8pt; COLOR: #a9a9a9;"> Handynummer &uuml;berpr&uuml;fen | <b style="FONT-SIZE: 8pt; COLOR: #000000;"><u>Login</u></b> | <span style="FONT-SIZE: 8pt; COLOR: #a9a9a9;">Interneteinstellungen</b> | <span style="FONT-SIZE: 8pt; COLOR: #a9a9a9;">Starten</b>
	</p>
	...
	<p align="center">
		...
		<font size="4">
			...
			Trage deine Handynummer und den PIN aus der SMS hier ein, um die Handy Download Software zu erhalten.
		</font>
	</p>
  ...
  <tr height="10">
	...
	<form method="POST" action="/signup.php">
		...
		Einfach Deine Handynummer eingeben und gratis testen*</p>
		<center>Deine Handynummer: 
  ...
  <tr>
    ...
    <td width="749" height="139" valign="top">
		...
		<table border="0" width="100%" height="139">
			...
			<tr>
				<td width="244" align="left">Deine Handynummer:</td>
...
function TarifePage( $MobilePhone ){
	...
	$volumeHandySearchesCall2PayURI		= generateMicropaymentBillingURIforVolumeHandyCallToPay( $MobilePhone );	# 30 suchen
	...
	$BUY_VOLUMENHANDY_SUCCESS			= BUY_VOLUMENHANDY_SUCCESS;
	$BUY_VOLUMENHANDY_SUCCESS_DOWNLOADS	= BUY_VOLUMENHANDY_SUCCESS * DOWNLOADSOURCEMULTIPLY;

	$BUY_VOLUMENBIG_SUCCESS				= BUY_VOLUMENBIG_SUCCESS;
	$BUY_VOLUMENBIG_SUCCESS_DOWNLOADS	= BUY_VOLUMENBIG_SUCCESS * DOWNLOADSOURCEMULTIPLY; 

	$BUY_VOLUMENLOW_SUCCESS				= BUY_VOLUMENLOW_SUCCESS;
	$BUY_VOLUMENLOW_SUCCESS_DOWNLOADS	= BUY_VOLUMENLOW_SUCCESS * DOWNLOADSOURCEMULTIPLY; 
  ...
  <tr>
    ...
    <td width="749" height="124" valign="top">
		...
		<table border="1" width="100%" height="139" style="border-collapse: collapse" bordercolor="#C0C0C0">
			...
			<tr>
				<td align="left" bordercolor="#C0C0C0">
					3 Tage<span class="small-text"> ( 3 Tage unbegrenzt suchen und downloaden )</span>
				</td>
				<td align="right" bordercolor="#C0C0C0">
					$prizeFlatHandy	EUR
				</td>
				<td align="left" bordercolor="#C0C0C0" width="65%">
					...
					<tr> 
					 ...
					 <td width="80" align="center">  
					<a href="$flatrate5daysLastschrift" title="Bezahlen Sie die BitJoe.de 3 Tages Flatrate per Lastschrift" target="_blank" rel="nofollow"><img border="0" src="/images/button_anmeldung_lastschrift.jpg" alt="Bezahlen Sie die BitJoe.de 3 Tages Flatrate per Lastschrift" width="65" height="31" /></a>
					</td>

					 <td width="80" align="center">  
					<a href="$flatrate5dayseBank" title="Bezahlen Sie die BitJoe.de 3 Tages Flatrate per &Uuml;berweisung" target="_blank" rel="nofollow"><img border="0" src="/images/button_anmeldung_ebank.jpg" alt="Bezahlen Sie die BitJoe.de 3 Tages Flatrate per &Uuml;berweisung" width="65" height="31" /></a>
					</td>

					 <td width="80" align="center">  
					<form method="post" action="https://www.paypal.com/cgi-bin/webscr" target="_blank">
						<input type="image" src="/images/button_anmeldung_paypal.jpg" border="0" name="submit" title="Bezahlen Sie die BitJoe.de 3 Tages Flatrate mit Paypal" alt="Bezahlen Sie die BitJoe.de 3 Tages Flatrate mit Paypal">
						<input type="hidden" name="cmd" value="_xclick">
						<input type="hidden" name="return" value="http://www.bitjoe.de/login/">
						<input type="hidden" name="business" value="support@bitjoe.at">
						<input type="hidden" name="item_name" value="$paypalFlatHandy[1]">
						<input type="hidden" name="item_number" value="$paypalFlatHandy[0]">
						<input type="hidden" name="amount" value="$paypalFlatHandy[2]">
						<input type="hidden" name="currency_code" value="EUR">
						<input type="hidden" name="bn"  value="ButtonFactory.PayPal.001">
					</form>
					</td>
					 ...
					 <td width="80" align="center">  
					<a href="$flatrate5daysCall2Pay" title="Bezahlen Sie die BitJoe.de 3 Tages Flatrate per Telefonanruf" target="_blank" rel="nofollow"><img border="0" src="/images/button_anmeldung_phone.jpg" alt="Bezahlen Sie die BitJoe.de 3 Tages Flatrate per Telefonanruf" width="65" height="31" /></a>
					</td>
			...
			<tr>
				<td align="left" bordercolor="#C0C0C0">
					$BUY_VOLUMENBIG_SUCCESS Suchanfragen
					<span class="small-text">(bis zu $BUY_VOLUMENBIG_SUCCESS_DOWNLOADS Downloads)</span>
				</td>
				...
				<td align="left" bordercolor="#C0C0C0" width="65%">
					...
					<form method="post" action="https://www.paypal.com/cgi-bin/webscr" target="_blank">
						<input type="image" src="/images/button_anmeldung_paypal.jpg" border="0" name="submit" title="Bezahlen Sie den BitJoe.de Volumentarif 2 mit Paypal" alt="Bezahlen Sie den BitJoe.de Volumentarif 2 mit Paypal">
						<input type="hidden" name="cmd" value="_xclick">
						<input type="hidden" name="return" value="http://www.bitjoe.de/login/">
						<input type="hidden" name="business" value="support@bitjoe.at">
						<input type="hidden" name="item_name" value="$paypalBIG[1]">
						<input type="hidden" name="item_number" value="$paypalBIG[0]">
						<input type="hidden" name="amount" value="$paypalBIG[2]">
						<input type="hidden" name="currency_code" value="EUR">
						<input type="hidden" name="bn"  value="ButtonFactory.PayPal.001">
					</form>
					</td>
					 ...
					 <td width="70" align="center">  
					<a href="$volumeThirtySearchesCall2PayURI" title="Bezahlen Sie den BitJoe.de Volumentarif 1 per Telefonanruf" target="_blank" rel="nofollow"><img border="0" src="/images/button_anmeldung_phone.jpg" alt="Bezahlen Sie den BitJoe.de Volumentarif 1 per Telefonanruf" width="65" height="31" /></a>
					</td>
			...
			<tr>
				<td align="left" bordercolor="#C0C0C0">
					$BUY_VOLUMENLOW_SUCCESS Suchanfragen <span class="small-text">(bis zu $BUY_VOLUMENLOW_SUCCESS_DOWNLOADS Downloads)</span>
				</td>
				<td align="right" bordercolor="#C0C0C0">
					$prizeLOW EUR 
				</td>
				<td align="left" bordercolor="#C0C0C0" width="65%">
					...
					<tr>  
					 <td width="70" align="center">  
							...
							<form method="post" action="https://www.paypal.com/cgi-bin/webscr" target="_blank">
							<input type="image" src="/images/button_anmeldung_paypal.jpg" border="0" name="submit" title="Bezahlen Sie den BitJoe.de Volumentarif 1 mit Paypal" alt="Bezahlen Sie den BitJoe.de Volumentarif 1 mit Paypal">
							<input type="hidden" name="cmd" value="_xclick">
							<input type="hidden" name="return" value="http://www.bitjoe.de/login/">
							<input type="hidden" name="business" value="support@bitjoe.at">
							<input type="hidden" name="item_name" value="$paypalLOW[1]">
							<input type="hidden" name="item_number" value="$paypalLOW[0]">
							<input type="hidden" name="amount" value="$paypalLOW[2]">
							<input type="hidden" name="currency_code" value="EUR">
							<input type="hidden" name="bn"  value="ButtonFactory.PayPal.001">
						</form>
					 ...
					 <td width="70" align="center">  
					<a href="$volumeTenSearchesCall2PayURI" title="Bezahlen Sie den BitJoe.de Volumentarif 2 per Telefonanruf" target="_blank" rel="nofollow"><img border="0" src="/images/button_anmeldung_phone.jpg" alt="Bezahlen Sie den BitJoe.de Volumentarif 2 per Telefonanruf" width="65" height="31" /></a>
					</td>
...
<head>
	...
	<link href="/css/bitjoe.css" rel="stylesheet" type="text/css" />
	<link href="/images/favicon.ico" rel="SHORTCUT ICON" />
	<title>BitJoe.de - Handynummer &uuml;berpr&uuml;fen</title>
...
<table width="778" border="0" cellpadding="0" cellspacing="0" height="506" style="margin: 0px">
  ...
  <tr>
	...
	<table border="0" width="100%" style="border-collapse: collapse">
		...
		<tr>
			<td width="550">
				<span style="font-size: 8pt;">Du bist hier:</span> <b style="FONT-SIZE: 8pt; COLOR: #000000;"> <u>Handynummer &uuml;berpr&uuml;fen</u> </b> | <span style="FONT-SIZE: 8pt; COLOR: #a9a9a9;">Login | Interneteinstellungen</b> | Starten</span>
			</td>
		</tr>
		</table>
	...
	<p align="center">
		...
		<table border="1">
			...
			<tr width="40%">
				<br>BitJoe Handynummer Pr&uuml;fung: <br>
			...
			<tr width="80%">
				...
				<td width="40%">
					<form method="POST" action="/checksettings.php">
						...
						<b>Meine Handynummer ist richtig:</b><br><br>
						...
						<input type="submit" value="Handynummer ist richtig!" title="Deine Handynummer ist korrekt.">
				...
				<td width="40%">
					<form method="POST" action="/checksettings.php">
						...
						<b>Meine Handynummer &auml;ndern:</b><br><br>
						Deine neue Handynummer: <br>
						...
						<input type="submit" value="Handynummer &auml;ndern!" title="Beim Eintragen deiner Handynummer ist ein Fehler aufgetreten, &auml;ndere Sie.">
		...
		<table border="1" width="100%" height="139" style="border-collapse: collapse" bordercolor="#C0C0C0">
			...
			<tr>
				...
				<td align="left" bordercolor="#C0C0C0" width="65%">
					...
					<td width="80" align="center">  
					<img border="0" src="/images/button_anmeldung_lastschrift.jpg" alt="Bezahlen Sie die BitJoe.de 3 Tages Flatrate per Lastschrift" width="65" height="31" />
					</td>

					 <td width="80" align="center">  
					<img border="0" src="/images/button_anmeldung_ebank.jpg" alt="Bezahlen Sie die BitJoe.de 3 Tages Flatrate per &Uuml;berweisung" width="65" height="31" />
					</td>

					 <td width="80" align="center">  
						<img src="/images/button_anmeldung_paypal.jpg" border="0" alt="Bezahlen Sie die BitJoe.de 3 Tages Flatrate mit Paypal" width="65" height="31" />
				
					</td>

					 <td width="80" align="center">  
					<img border="0" src="/images/button_anmeldung_phone.jpg" alt="Bezahlen Sie die BitJoe.de 3 Tages Flatrate per Telefonanruf" width="65" height="31" />
					</td>
				...
				<td align="left" bordercolor="#C0C0C0" width="65%">
					...
					<tr>  
					 <td width="70" align="center">  
						...
						<img src="/images/button_anmeldung_paypal.jpg" border="0" name="submit" title="Bezahlen Sie den BitJoe.de Volumentarif 2 mit Paypal" alt="Bezahlen Sie den BitJoe.de Volumentarif 2 mit Paypal" />
						
					</form>
					</td>

					 <td width="70" align="center">  
					<img border="0" src="/images/button_anmeldung_phone.jpg" alt="Bezahlen Sie den BitJoe.de Volumentarif 1 per Telefonanruf" width="65" height="31" />
					</td>
				...
				<td align="left" bordercolor="#C0C0C0" width="65%">
					...
					<tr>  
					 <td width="70" align="center">  
						...
						<img src="/images/button_anmeldung_paypal.jpg" border="0" name="submit" title="Bezahlen Sie den BitJoe.de Volumentarif 1 mit Paypal" alt="Bezahlen Sie den BitJoe.de Volumentarif 1 mit Paypal" />
							

					</td>

					 <td width="70" align="center">  
					<img border="0" src="/images/button_anmeldung_phone.jpg" alt="Bezahlen Sie den BitJoe.de Volumentarif 2 per Telefonanruf" width="65" height="31" />
					</td>
