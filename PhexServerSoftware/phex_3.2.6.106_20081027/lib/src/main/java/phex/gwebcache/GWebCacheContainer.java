 ...
 * 
 *  --- SVN Information ---
 *  $Id: GWebCacheContainer.java 4231 2008-07-15 16:01:10Z gregork $
 */
...
public class GWebCacheContainer
{
    ...
    static
    {
        ...
        String[] arr =
        {
            "http://gc-phex02.rakjar.de/gcache.php", "http://gc-fust01.rakjar.de/gcache.php", "http://phexgwc.kouk.de/gcache.php"
        };
    ...
    private void initializeGWebCacheContainer()
    {
        ...
        final File gWebCacheFile = servent.getGnutellaNetwork().getGWebCacheFile();
        // to speed up returning from method... do loading in background
        Runnable runner = new Runnable()
        {
            public void run()
            {
                loadGWebCacheFromFile( gWebCacheFile );
            }
        };
...
//        }
    ...
    private void loadGWebCacheFromFile( File gWebCacheFile )
    {
        try
        {
