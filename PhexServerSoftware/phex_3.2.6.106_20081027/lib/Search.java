 ...
 * 
 *  --- CVS Information ---
 *  $Id: Search.java 4222 2008-07-10 15:44:51Z gregork $
 */
package phex.query;
...
{   
    ...
    public int getProgress()
    {
        ...
        else
        {
            ...
            //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            long currentTime = System.currentTimeMillis();
            int timeProgress = (int)(100.0 - (double)( startTime + BitJoePrefs.StopTimeSetting.get() - currentTime )
                / (double)BitJoePrefs.StopTimeSetting.get()* 100.0 );
            return Math.min( timeProgress, 100);
            //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        }
    }
    ...
    public void checkForSearchTimeout( long currentTime )
    {
        ...
        //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        else if ( currentTime > startTime + BitJoePrefs.StopTimeSetting.get())
        {
            stopSearching();
        }
        //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    public void startSearching( final QueryManager queryService )
    {
        AsynchronousDispatcher.invokeLater( new Runnable()
        {
            public void run()
            {
                ...
                queryEngine = queryService.sendMyQuery( queryMsg );
                isSearching = true;
                fireSearchStarted();
            }
        } );
