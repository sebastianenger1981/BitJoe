...
public class QuickFilterPanel extends JPanel
{
    ...
    private static JComboBox mediaTypeComboBox;
    private static JTextField minFileSizeTF;
    private FWSizeDefComboBox minFileSizeUnitComboBox;
    private static JTextField maxFileSizeTF;
    ...
    //************************************************************************
    public static void setMinFile(String s){
    	minFileSizeTF.setText(s);
    }
    public static void setMaxFile(String s){
    	maxFileSizeTF.setText(s);
    }
    public static void setMediaType(int i){
    	mediaTypeComboBox.setSelectedIndex(i);
    }		 
//************************************************************************ 
