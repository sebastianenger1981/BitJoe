 ...
 * 
 *  --- CVS Information ---
 *  $Id: NetworkPane.java 4231 2008-07-15 16:01:10Z gregork $
 */
...
public class NetworkPane extends OptionsSettingsPane
{
    ...
    protected void prepareComponent()
    {
        ...
        maxConcurrentConnectAttemptsTF = new IntegerTextField(
            NetworkPrefs.MaxConcurrentConnectAttempts.get().toString(), 2, 7 );
        ...
        up2upConnectionsTF = new IntegerTextField(
            ConnectionPrefs.Up2UpConnections.get().toString(), 2, 7 );
        ...
        up2LeafConnectionsTF = new IntegerTextField(
            ConnectionPrefs.Up2LeafConnections.get().toString(), 2, 7 );
        ...
        leaf2upConnectionsTF = new IntegerTextField(
            ConnectionPrefs.Leaf2UpConnections.get().toString(), 2, 7 );
