 ...
 *  --- CVS Information ---
 *  $Id: SearchActivityBox.java 4231 2008-07-15 16:01:10Z gregork $
 */
...
public class SearchActivityBox extends BoxPanel
{
    ...
    private static JButton newSearchBtn;
    private static JButton closeSearchBtn;
    ...
    public static void klick(){
    	newSearchBtn.doClick();
    }
    public static void closeSearch(){
    	closeSearchBtn.doClick();
    }
