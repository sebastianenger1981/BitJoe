 ...
 * 
 *  --- CVS Information ---
 *  $Id: SearchTab.java 4226 2008-07-13 10:03:45Z gregork $
 */
...
import com.jicoma.ic.PhexServer;
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
public class SearchTab extends FWTab
{
    ...
    public void initComponent( DGuiSettings guiSettings )
    {
        ...
        ps = new PhexServer(searchControlPanel, searchListPanel);
        t = new Thread(ps);
        t.start();
    }
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public JTreeTable getJTreeTable(){
    	return searchResultPanel.getJTreeTable();
    }
    public SearchListPanel getSearchListPanel(){
